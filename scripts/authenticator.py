...
imp.load_module('electrum_tao', *imp.find_module('lib'))

from electrum_tao import SimpleConfig, Wallet, WalletStorage, format_satoshis
from electrum_tao import util
from electrum_tao.transaction import Transaction
from electrum_tao.bitcoin import base_encode, base_decode
    ...
    content = """
      ...
      <LinearLayout 
        ...
        <TextView
          ...
          android:text="Electrum-TAO Authenticator"
...
class Authenticator:
    ...
    def __init__(self):
        global wallet
        self.qr_data = None
        storage = WalletStorage('/sdcard/electrum-tao/authenticator')
