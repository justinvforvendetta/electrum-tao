...
_ = lambda x:x
#from i18n import _
from electrum_tao.wallet import WalletStorage, Wallet
from electrum_tao.util import format_satoshis, set_verbosity, StoreDict
from electrum_tao.bitcoin import is_valid
from electrum_tao.network import filter_protocol
...
class ElectrumGui:
    ...
    def __init__(self, config, network):
        ...
        if not storage.file_exists:
            print "Wallet not found. try 'electrum-tao create'"
            exit()
    ...
    def network_dialog(self):
        print("use 'electrum-tao setconfig server/proxy' to change your network settings")
        return True


    def settings_dialog(self):
        print("use 'electrum-tao setconfig' to change your settings")
        return True
