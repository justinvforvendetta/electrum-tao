...
from electrum_tao.util import print_error, InvalidPassword
from electrum_tao.bitcoin import is_valid
from electrum_tao import WalletStorage, Wallet

Gdk.threads_init()
APP_NAME = "Electrum-TAO"
import platform
MONOSPACE_FONT = 'Lucida Console' if platform.system() == 'Windows' else 'monospace'

from electrum_tao.util import format_satoshis, parse_URI
from electrum_tao.network import DEFAULT_SERVERS
from electrum_tao.bitcoin import MIN_RELAY_TX_FEE
...
class ElectrumWindow:
    ...
    def __init__(self, wallet, config, network):
        ...
        title = 'Electrum-TAO ' + self.wallet.electrum_version + '  -  ' + self.config.path
        ...
        from electrum_tao.util import StoreDict
    ...
    def do_send(self, w, data):
        ...
        if not is_valid(to_address):
            self.show_message( "invalid tao address:\n"+to_address)
            return
