...
from electrum_tao.bitcoin import is_valid
...
import re
import time
from electrum_tao.wallet import Wallet, WalletStorage
import webbrowser
import history_widget_lite
import receiving_widget
from electrum_tao import util
import datetime

from electrum_tao.version import ELECTRUM_VERSION as electrum_version
from electrum_tao.util import format_satoshis, age
...
class MiniWindow(QDialog):
    ...
    def __init__(self, actuator, expand_callback, config):
        ...
        self.address_input.setPlaceholderText(_("Enter a Tao address or contact"))
        ...
        self.setWindowTitle("Electrum-TAO")
...
class ReceivePopup(QDialog):
    ...
    def setup(self, address):
        label = QLabel(_("Copied your Tao address to the clipboard!"))
        ...
        self.setWindowTitle("Electrum - " + _("Receive Tao payment"))
