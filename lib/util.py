...
def user_dir():
    if "HOME" in os.environ:
        return os.path.join(os.environ["HOME"], ".electrum-tao")
    elif "APPDATA" in os.environ:
        return os.path.join(os.environ["APPDATA"], "Electrum-TAO")
    elif "LOCALAPPDATA" in os.environ:
        return os.path.join(os.environ["LOCALAPPDATA"], "Electrum-TAO")
    elif 'ANDROID_DATA' in os.environ:
        return "/sdcard/electrum-tao/"
    else:
...
def create_URI(addr, amount, message):
    ...
    p = urlparse.ParseResult(scheme='tao', netloc='', path=addr, params='', query='&'.join(query), fragment='')
